...
var campaignID = "67dbd5fc702992c391d82f82";
...
var initialSrc = "https://track.riddlerewardsusa.top/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("track.riddlerewardsusa.top/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://track.riddlerewardsusa.top/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://track.riddlerewardsusa.top/view?clickid=" + rtkClickID)
        xhrTrack.send();
